...
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (1, 'Толковый словарь русского языка');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (2, 'Энциклопедия "Слово"');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (3, 'Учебник "Русский язык: синтаксис и стилистика"');

INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (4, 'Онлайн-энциклопедия "Википедия"');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (5, 'Словарь синонимов и антонимов');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (6, 'Научно-популярная статья в журнале "Наука и жизнь"');

INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (7, 'Лингвистический журнал "Язык и текст"');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (8, 'Учебное пособие по русскому языку для школьников');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (9, 'Интернет-ресурс "Грамота.ру"');

INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (10, 'Словарь русского языка в 4 томах');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (11, 'Учебник по лингвистике для студентов');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (12, 'Статья в литературном журнале "Новый мир"');

INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (13, 'Справочник по русскому языку для изучающих иностранные языки');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (14, 'Электронный словарь современного русского языка');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (15, 'Учебное пособие по стилистике для лингвистов');

INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (16, 'Научная статья в журнале "Языкознание"');
INSERT INTO "definitions"."source" ("definition_id", "source") VALUES (17, 'Словарь русского языка с толкованиями');
